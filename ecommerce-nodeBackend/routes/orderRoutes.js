...
//       const product = await Product.findOne({ product_id: item.product_id }); // ✅ fixed here
//       if (!product) {
...
//         { product_id: item.product_id }, // ✅ fixed here
